                ...
                <div id="scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="main.php">
                                    <i class=" ri-file-copy-2-line"></i> <span data-key="t-widgets">Add Service</span>
                                </a>
                            </li>
                            <?php }  ?>
                            <?php if ($tipo_usuario == 1) {  ?>
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="users.php">
                                    <i class="ri-user-add-line"></i> <span data-key="t-widgets">Add users</span>
                                </a>
                            </li>
                            <?php }  ?>
                            <!-- Nuevo enlace reports -->
                            <?php if ($tipo_usuario == 1) {  ?>
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="reports.php">
                                    <i class=" ri-file-copy-2-line"></i> <span data-key="t-widgets">Reports</span>
                                </a>
                            </li>
                            <?php }  ?>
                            <?php if ($tipo_usuario == 2 || $tipo_usuario == 3 ) {  ?>
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="main_services.php">
                                    <i class=" ri-file-copy-2-line"></i> <span data-key="t-widgets">Control</span>
                                </a>
                            </li>
                            <?php }  ?>
